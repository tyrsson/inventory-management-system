...
final class ConfigProvider
{
    ...
    public function getDependencies(): array
    {
        return [
            ...
            'factories' => [
                ...
                Admin\RequestHandler\UpdateUserModalHandler::class =>
                    Admin\RequestHandler\Container\UpdateUserModalHandlerFactory::class,
                Admin\RequestHandler\CreateUserHandler::class =>
                    Admin\RequestHandler\Container\CreateUserHandlerFactory::class,
                Admin\RequestHandler\ToggleUserActiveHandler::class =>
                    Admin\RequestHandler\Container\ToggleUserActiveHandlerFactory::class,
                CommandHandler\SaveUserHandler::class => CommandHandler\Container\SaveUserHandlerFactory::class,
                CommandHandler\ToggleUserActiveHandler::class =>
                    CommandHandler\Container\ToggleUserActiveHandlerFactory::class,
                ...
                Middleware\ProcessToggleUserActiveMiddleware::class =>
                    Middleware\Container\ProcessToggleUserActiveMiddlewareFactory::class,
                Middleware\ProcessUpdateUserMiddleware::class =>
                    Middleware\Container\ProcessUpdateUserMiddlewareFactory::class,
                ...
                RequestHandler\ResendVerificationHandler::class =>
                    RequestHandler\Container\ResendVerificationHandlerFactory::class,
                ...
                Listener\SendVerificationEmailListener::class =>
                    Listener\Container\SendVerificationEmailListenerFactory::class,
    ...
    public function getDefaultConfig(): array
    {
        return [
            ...
            Container\Configuration::ADMIN_ROUTE_NAME_PREFIX_KEY =>
        ...
        return [
            ...
            'resources' => [
                ...
                AdminConfiguration::ADMIN_ROUTE_NAME_PREFIX_VALUE
                    . rtrim(Container\Configuration::ADMIN_ROUTE_NAME_PREFIX_VALUE, '.') => true,
                AdminConfiguration::ADMIN_ROUTE_NAME_PREFIX_VALUE
                    . Container\Configuration::ADMIN_ROUTE_NAME_PREFIX_VALUE
                    . 'create' => true,
                AdminConfiguration::ADMIN_ROUTE_NAME_PREFIX_VALUE
